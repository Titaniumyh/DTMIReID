...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     "--config_file", default="/root/autodl-tmp/TransReid/configs/market1501.yml", help="path to config file", type=str
    # )
    parser.add_argument(
        "--config_file", default="D:\YDTC\REIDProject\hhhh\DeformableReid\YHReID1\configs\dukemtmc.yml",
